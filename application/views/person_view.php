...
<html>
    ...
    <title>CodeIgniter CRUD with AJAX , Bootstrap and Datatables</title>
...
<div id="content">
  ...
  <script type="text/javascript">
    ...
    function save()
    {
      ...
      {
        // modified
        // i have passed the id to this because in my controller 
        // iam using function as paramter that why i have to pass the id to it.
        url = "<?php echo site_url('person/ajax_update')?>/" + $('#id').val(); // Pass the ID here
      }
